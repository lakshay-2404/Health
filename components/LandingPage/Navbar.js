        ...
        <nav className='fixed w-full left-0 top-0 z-[999]'>
            <div className='flex items-center justify-between'>
                <div className='mx-7'>
                    ...
                    <span className=''>Healthverse</span>
                ...
                <div className='text-white md:block  px-7 py-2 font-medium bg-gray-900 rounded-bl-full   ' >
                    <ul className='flex items-center gap-8  text-lg '>
                        ...
                        <Link href="https://healthverseblogs.netlify.app" target="_blank" rel="noopener noreferrer"><li className="hidden md:block">Blog</li></Link>
